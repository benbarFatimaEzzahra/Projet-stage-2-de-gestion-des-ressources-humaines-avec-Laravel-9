				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Modifier congé</a></li>
                        </ol>
                    </div>
                </div>
							...
							<div class="card-body">
                                <form action="{{ url('cong/' .$congs->id) }}" method="post">
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Date du début de congé</label>
												<input type="text" name="date_debut" id="date_debut" value="{{$congs->date_debut}}" class="form-control"></br>
											</div>
										</div>
									    <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Date du fin de congé</label>
