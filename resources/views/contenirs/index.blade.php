				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Suivi des congés</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Suivi des congés</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Liste de suivi des congés</a></li>
                        </ol>
                    </div>
                </div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Liste de suivi des congés</h4>
								<a href="{{ url('/contenir/create') }}" class="btn btn-primary">+ Ajouter</a>
							</div>
									...
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
											...
											<tr>
												...
												<td>{{ $contenir->libelle_type}}</td>
                                               
                                                <td>{{ $contenir->date_debut}}</td>
												<td>{{ $contenir->date_fin}}</td>
                                                <td>{{ $contenir->titre}}</td>
												
												
												<td>
                                                   <div class="btn-group"> 
                                                    <a href="{{ route('contenir.edit',['contenir' => $contenir->id]) }}" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                                    <a href=""></a>
                                                    <form action="{{ route('contenir.destroy',['contenir' => $contenir->id]) }}" method="post">
                                                          @csrf
                                                          @method('DELETE')
