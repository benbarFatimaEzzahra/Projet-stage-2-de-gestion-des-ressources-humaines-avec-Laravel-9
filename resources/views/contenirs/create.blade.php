				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Ajouter suivi de congé</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Suivi de congé</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Ajouter suivi</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="{{url('/contenir')}}" method="post">
                                    @csrf
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Id jour férié</label>
												<input type="text" name="jour_id" id="jour_id" class="form-control">
											</div>
										</div>
