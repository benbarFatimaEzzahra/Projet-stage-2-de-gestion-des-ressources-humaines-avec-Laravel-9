				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Liste des absences</a></li>
                        </ol>
                    </div>
                </div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								...
								<a href="{{ url('/absence/create') }}" class="btn btn-primary">+ Ajouter</a>
							</div>
									...
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
											...
											<tr>
                                                ...
                                                <td>{{ $absence->nom_s}}</td>
												<td>{{ $absence->dscription}}</td>
                                                
                                                <td>{{ $absence->date_debut_abs}}</td>
												<td>{{ $absence->date_fin_abs}}</td>
												<td>
                                                   <div class="btn-group"> 
                                                    <a href="{{ route('absence.edit',['absence' => $absence->id]) }}" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                                    <a >
