				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Modéfier absence</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Absences</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Modéfier absence</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="{{ url('absence/' .$absences->id) }}" method="post">
                                    {!! csrf_field() !!}
                                    @method("PATCH")
									<div class="row">
                                         <input type="hidden" name="id" id="id" value="{{$absences->id}}" id="id" />
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Id personnel</label>
												<input type="text" name="personnel_id" id="personnel_id" value="{{$absences->personnel_id}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Déscription</label>
												<input type="text" name="dscription" id="dscription" value="{{$absences->dscription}}" class="form-control"></br>
											</div>
										</div>
									    <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Date début d'absence</label>
												<input type="text" name="date_debut_abs" id="date_debut_abs" value="{{$absences->date_debut_abs}}" class="form-control"></br>
											</div>
										</div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Date fin d'absence</label>
												<input type="text" name="date_fin_abs" id="date_fin_abs" value="{{$absences->date_fin_abs}}" class="form-control"></br>
											</div>
										</div>
