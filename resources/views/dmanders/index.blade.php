				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Liste de demande de congé</a></li>
                        </ol>
                    </div>
                </div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Liste de demande de congé</h4>
								<a href="{{ url('/dmander/create') }}" class="btn btn-primary">+ Ajouter</a>
							</div>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                            @foreach($dmanders as $dmander)
											<tr>
                                                <td>{{ $dmander->nom}}</td>
                                                <td>{{ $dmander->prenom}}</td> 
                                                <td>{{ $dmander->nom_s}}</td>
												<td>{{ $dmander->libelle_type}}</td>
                                                <td>{{ $dmander->date_debut}}</td>
												<td>{{ $dmander->date_fin}}</td>
                                                <td>{{ $dmander->commentaires_dem}}</td>
												
												
												<td>
                                                   <div class="btn-group"> 
                                                    <a href="{{ route('dmander.edit',['dmander' => $dmander->cong_id],['dmander' => $dmander->personnel_id]) }}" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                                    <a href=""></a>
                                                    <form action="{{ route('dmander.destroy',['dmander' =>  $dmander->cong_id]) }}" method="post">
                                                          @csrf
                                                          @method('DELETE')
                                                        <button class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></button>
                                                     </form>
                                                     </a>                                                                                                    
                                                    <a href="{{ URL::to('/pdf') }}" class="btn btn-sm btn-success"><i class="la la-download"></i></a>
                                                    </div>
                                                </td>
