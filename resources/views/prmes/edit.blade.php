				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Modifier Prime</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="{{ url('prme/' .$prmes->id) }}" method="post">
                                    {!! csrf_field() !!}
                                    @method("PATCH")
									<div class="row">
                                         <input type="hidden" name="id" id="id" value="{{$prmes->id}}" id="id" />
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Id personnel</label>
												<input type="text" name="personnel_id" id="personnel_id" value="{{$prmes->personnel_id}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Prime</label>
												<input type="text" name="montant_prime" id="montant_prime" value="{{$prmes->montant_prime}}" class="form-control"></br>
											</div>
										</div>
									    <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Commentaire</label>
												<input type="text" name="commentaires" id="commentaires" value="{{$prmes->commentaires}}" class="form-control"></br>
											</div>
										</div>
