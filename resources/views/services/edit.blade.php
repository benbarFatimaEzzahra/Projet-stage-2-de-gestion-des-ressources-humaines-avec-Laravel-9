									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" name="nom_s" id="nom_s" value="{{$services->nom_s}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Nombre des employées</label>
												<input type="text" name="nbr_employes" id="nbr_employes" value="{{$services->nbr_employes}}" class="form-control"></br>
											</div>
										</div>
