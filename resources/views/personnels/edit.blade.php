                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Modifier Personnel</a></li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <input type="hidden" name="id" id="id" value="{{$personnels->id}}" id="id" />
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" name="service_id" id="service_id" value="{{$personnels->service_id}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Nom</label>
												<input type="text" name="nom" id="nom" value="{{$personnels->nom}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Prénom</label>
												<input type="text" name="prenom" id="prenom" value="{{$personnels->prenom}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">CIN</label>
												<input type="text" name="cin" id="cin" value="{{$personnels->cin}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Date d'ambauche</label>
												<input type="date" name="date_ambauche" id="date_ambauche" value="{{$personnels->date_ambauche}}" class="form-control">
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" name="fonction" id="fonction" value="{{$personnels->fonction}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Salaire</label>
												<input type="float" name="salaire_de_base" id="salaire_de_base" value="{{$personnels->salaire_de_base}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Sexe</label>
												<input type="text" name="sexe" id="sexe" value="{{$personnels->sexe}}" class="form-control">
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="date" name="date_naissance" id="date_naissance" value="{{$personnels->date_naissance}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Lieu de naissance</label>
												<input type="text" name="lieu_naissance" id="lieu_naissance" value="{{$personnels->lieu_naissance}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Situation familiale</label>
												<input type="text" name="situation_familial" id="situation_familial" value="{{$personnels->situation_familial}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Nombre des enfants</label>
												<input type="text" name="nbr_enfant" id="nbr_enfant" value="{{$personnels->nbr_enfant}}" class="form-control">
											</div>
										</div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" name="adresse" id="adresse" value="{{$personnels->adresse}}" class="form-control">
											</div>
										</div>
                                       <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Téléphone</label>
												<input type="text" name="tel" id="tel" value="{{$personnels->tel}}" class="form-control">
											</div>
										</div>
                                       ...
                                       <div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group fallback w-100">
                                                <label>Fichier</label>
                                                <input type="file" name="fichier" id="fichier" value="{{$personnels->fichier}}" class="form-control">
											</div>
										</div>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group fallback w-100">
                                                <label>Photo</label>
                                                <input class="form-control" name="photo" type="file" id="photo" value="{{$personnels->photo}}">
											</div>
										</div>
										<div class="col-lg-12 col-md-12 col-sm-12">
