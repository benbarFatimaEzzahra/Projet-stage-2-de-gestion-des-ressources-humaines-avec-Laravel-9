				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Liste des Personnels</a></li>
                        </ol>
                    </div>
                </div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								...
								<a href="{{ url('/personnel/create') }}" class="btn btn-primary">+ Ajouter</a>
							</div>
							...
							<div class="card-body">
                                ...
                                @foreach($personnels as $item)
                                    <tr>
                                       ...
                                       <!-- <td> <form action="{{url('service',[$item->id])}} » method="post »>
                                         {{csrf_field()}} </td> -->
                                         <td>{{ $item->nom_s }}</td>
                                        ...
                                        <img src="{{asset('/storage/images/'.$item->photo) }}" width= '50' height='50' class="img img-responsive" />
                                        	...
                                        	<td>
                                                   <div class="btn-group"> 
                                                    <a href="{{ route('personnel.edit',['personnel' => $item->id]) }}" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                                    <a >
                                                    ...
                                                    <a href="{{ route('personnel.show',['personnel' => $item->id]) }}" class="btn btn-sm btn-warning"><i class="la la-eye"></i></a>
                                                    </div>
                                                </td>
                                    </tr>
                                @endforeach
