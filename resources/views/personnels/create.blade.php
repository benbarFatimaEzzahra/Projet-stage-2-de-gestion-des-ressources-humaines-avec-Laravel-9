                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Ajouter Personnel</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                   <form action="{{url('/personnel')}}" method="post" enctype="multipart/form-data">
                  {!! csrf_field() !!}
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="date" name="date_ambauche" id="date_ambauche" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<select class="form-control">
													<option name="situation_familial" id="situation_familial"  value="Marié(e)">Marié(e)</option>
													<option name="situation_familial" id="situation_familial"  value="Divorcé(e)">Divorcé(e)</option>
													<option name="situation_familial" id="situation_familial"  value="Célibataire">Célibataire</option>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<select class="form-control">
													<option name="fonction" id="fonction"  value="Responsable">Responsable</option>
													<option name="fonction" id="fonction"  value="Majorant(e)">Majorant(e)</option>
													<option name="fonction" id="fonction"  value="Agent">Agent</option>
													<option name="fonction" id="fonction"  value="Médecin">Médecin</option>
													<option name="fonction" id="fonction"  value="Inférmire(e)">Inférmire(e)</option>
												</select>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="float" name="salaire_de_base" id="salaire_de_base" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<select class="form-control">
													<option name="sexe" id="sexe" value="F">F</option>
													<option name="sexe" id="sexe" value="M">M</option>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" name="nbr_enfant" id="nbr_enfant" class="form-control">
											</div>
										</div>
