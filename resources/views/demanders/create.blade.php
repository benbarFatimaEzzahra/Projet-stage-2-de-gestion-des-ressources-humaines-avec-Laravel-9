				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Ajouter demande de congé</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Ajouter demande</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="{{url('/demander')}}" method="post">
                                    @csrf
									...
									<div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" name="personnel_id" id="personnel_id" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Id congé</label>
												<input type="text" name="cong_id" id="cong_id" class="form-control">
											</div>
										</div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
                                                ...
                                                <select class="form-control">
													<option name="commentaires_dem" id="commentaires_dem" value="Validé">Validé</option>
													<option name="commentaires_dem" id="commentaires_dem" value="En cours">En cours</option>
                                                    <option name="commentaires_dem" id="commentaires_dem" value="Refusé">Refusé</option>
