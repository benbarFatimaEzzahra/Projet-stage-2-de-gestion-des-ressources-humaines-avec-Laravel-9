				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="{{ url('demander/' .$demanders->id) }}" method="post">
                                    {!! csrf_field() !!}
                                    @method("PATCH")
									<div class="row">
                                         <input type="hidden" name="id" id="id" value="{{$demanders->id}}" id="id" />
                                         <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Id personnel</label>
												<input type="text" name="personnel_id" id="personnel_id" value="{{$demanders->personnel_id}}" class="form-control">
											</div>
										</div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Id congé</label>
												<input type="text" name="cong_id" id="cong_id" value="{{$demanders->cong_id}}" class="form-control"></br>
											</div>
										</div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Date de demande</label>
												<input type="text" name="date_demande" id="date_demande" value="{{$demanders->date_demande}}" class="form-control"></br>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Etat</label>
												<input type="text" name="commentaires_dem" id="commentaires_dem" value="{{$demanders->commentaires_dem}}" class="form-control">
