					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								...
								<a href="{{ url('/demander/create') }}" class="btn btn-primary">+ Ajouter</a>
							</div>
								...
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
											...
											<tr>
                                                <td>{{ $demander->nom}}</td>
                                                <td>{{ $demander->prenom}}</td> 
                                                <td>{{ $demander->nom_s}}</td>
												<td>{{ $demander->libelle_type}}</td>
                                                <td>{{ $demander->date_debut}}</td>
												<td>{{ $demander->date_fin}}</td>
                                                <td>{{ $demander->commentaires_dem}}</td>
												
												
												<td>
                                                   <div class="btn-group"> 
                                                    <a href="{{ route('demander.edit',['demander' => $demander->id]) }}" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                                    <a href=""></a>
                                                    <form action="{{ route('demander.destroy',['demander' => $demander->id]) }}" method="post">
                                                          @csrf
                                                          @method('DELETE')
