				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Jour férié</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Liste des Jours fériés</a></li>
                        </ol>
                    </div>
                </div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Liste des Jours fériéss</h4>
								<a href="{{ url('/jour/create') }}" class="btn btn-primary">+ Ajouter</a>
							</div>
									...
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
											...
											<tr>
												...
												<td>
                                                   <div class="btn-group"> 
                                                    <a href="{{ route('jour.edit',['jour' => $jour->id]) }}" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                                    <a href=""></a>
                                                    <form action="{{ route('jour.destroy',['jour' => $jour->id]) }}" method="post">
                                                          @csrf
                                                          @method('DELETE')
