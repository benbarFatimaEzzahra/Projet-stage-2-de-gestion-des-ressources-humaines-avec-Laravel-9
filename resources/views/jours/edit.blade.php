				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Modifier jour férié</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Jours fériés</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Modifier Jour férié</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="{{ url('jour/' .$jours->id) }}" method="post">
                                    {!! csrf_field() !!}
                                    @method("PATCH")
									<div class="row">
                                         <input type="hidden" name="id" id="id" value="{{$jours->id}}" id="id" />
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Nom de jour férié</label>
												<input type="text" name="titre" id="titre" value="{{$jours->titre}}" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Date du jour férié</label>
												<input type="text" name="date" id="date" value="{{$jours->date}}" class="form-control"></br>
											</div>
										</div>
